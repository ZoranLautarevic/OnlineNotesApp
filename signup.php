...
$message .= "http://zoranlautarevic.offyoucode.co.uk/activate.php?email=" . urlencode($email) . "&key = $activationKey";
if(mail($email, "Confirm your Registration", $message, "From:" . "zlautarevic@gmail.com")) {
