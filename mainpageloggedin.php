      ...
      <div class="container" id="container">
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <div class="buttons">
                <button id="addNote" type="button" class="btn btn green btn-lg">Add Note</button>
                <button id="edit" type="button" class="btn btn green btn-lg pull-right">Edit</button>
                <button id="done" type="button" class="btn btn green btn-lg pull-right">Done</button>
                <button id="allNotes" type="button" class="btn btn green btn-lg">All Notes</button>
                </div>
