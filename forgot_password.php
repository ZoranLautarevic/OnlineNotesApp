...
$message .= "http://zoranlautarevic.offyoucode.co.uk/resetpassword.php?user_id=$user_id&key = $key";
if(mail($email, "Reset your password", $message, "From:" . "zlautarevic@gmail.com")) {
